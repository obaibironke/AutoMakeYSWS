...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-sans font-bold text-sm pr-4" style={{ color: "#0F1923" }}>
          {q}
        </span>
        <span
        ...
        {open && (
          ...
          >
            <div className="px-6 py-4 bg-white" style={{ borderTop: "1px solid rgba(15,25,35,0.1)" }}>
              <p className="font-sans text-sm leading-relaxed" style={{ color: "#0F1923" }}>
                {a}
              </p>
            </div>
          </motion.div>
...
function HeroSection({
  ...
  return (
    ...
    >
      <motion.div className="blob blob-1" style={{ width: 500, height: 500, background: "#00E5A0", top: "5%", left: "0%", x: blobX.b1, y: blobY.b1 }} />
      <motion.div className="blob blob-2" style={{ width: 380, height: 380, background: "#FF5733", top: "20%", right: "2%", x: blobX.b2, y: blobY.b2 }} />
      <motion.div className="blob blob-3" style={{ width: 300, height: 300, background: "#00E5A0", bottom: "10%", left: "25%", x: blobX.b3, y: blobY.b3 }} />
      <motion.div className="blob blob-4" style={{ width: 220, height: 220, background: "#FF5733", bottom: "15%", right: "15%", x: blobX.b4, y: blobY.b4 }} />
      ...
      >
        <motion.div
          ...
          style={{
            ...
            background: "#00E5A0", color: "#0F1923", borderRadius: "50%",
            width: 84, height: 84, display: "flex", alignItems: "center",
            justifyContent: "center", textAlign: "center", fontWeight: 800,
            fontSize: "0.65rem", lineHeight: 1.3, letterSpacing: "0.05em",
            boxShadow: "3px 3px 0px rgba(0,0,0,0.3)", zIndex: 20, flexDirection: "column",
          }}
        >
          FREE<br />TOOLS
        </motion.div>
        <motion.div
          ...
          style={{
            ...
            background: "#FF5733", color: "white", borderRadius: "50px",
            padding: "10px 16px", fontWeight: 800, fontSize: "0.6rem",
            lineHeight: 1.4, textAlign: "center", letterSpacing: "0.06em",
            boxShadow: "3px 3px 0px rgba(0,0,0,0.3)", zIndex: 20,
          }}
        >
        ...
        <motion.div
          ...
          style={{
            ...
            background: "#00E5A0", color: "#0F1923", borderRadius: "12px",
            padding: "8px 14px", fontWeight: 800, fontSize: "0.6rem",
            lineHeight: 1.4, textAlign: "center", letterSpacing: "0.06em",
            boxShadow: "3px 3px 0px rgba(0,0,0,0.3)", zIndex: 20,
          }}
        >
        ...
        <motion.div
          ...
          style={{ background: "rgba(245,240,232,0.1)", border: "1px solid rgba(245,240,232,0.2)" }}
        ...
        >
          <a href={RSVP_URL} target="_blank" rel="noopener noreferrer">
            <motion.span
              ...
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.boxShadow = "3px 3px 0px #0F1923";
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 z-10">
        <span className="font-sans text-[10px] font-semibold uppercase tracking-[0.2em]" style={{ color: "rgba(0,229,160,0.7)" }}>
          scroll
        </span>
        <motion.svg
          width="18" height="18" viewBox="0 0 24 24"
          fill="none" stroke="#00E5A0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          animate={{ y: [0, 6, 0] }}
...
function AboutSection({ dir }: { dir: number }) {
  return (
    <div className="w-full h-full flex items-center justify-center overflow-hidden relative" style={{ background: "#F5F0E8" }}>
      <div
        style={{
          position: "absolute", bottom: "-4%", right: "-1%",
          fontSize: "22vw", fontWeight: 900, color: "rgba(15,25,35,0.04)",
      ...
      <motion.div
        ...
        custom={dir} variants={contentVariants} initial="enter" animate="center" exit="exit"
      >
        <div className="mb-6">
        ...
        <h2 className="font-sans font-extrabold mb-8 leading-tight" style={{ color: "#0F1923", fontSize: "clamp(2.8rem, 6vw, 5rem)" }}>
          <span style={{ display: "inline", background: "#00E5A0", borderRadius: "6px", padding: "0 10px 2px", marginRight: "12px" }}>
            Why
          </span>
          Automake?
        </h2>
        <p className="font-sans leading-relaxed" style={{ color: "#0F1923", fontSize: "clamp(1.1rem, 2.2vw, 1.5rem)", maxWidth: "780px" }}>
          Automations can be used for amazing things. They power useful tools like Slack bots or fun email responders.{" "}
          <span style={{ fontWeight: 800, color: "#00E5A0" }}>Automake</span>{" "}
          exists to provide a place{" "}
          <span style={{ fontWeight: 800, color: "#00E5A0" }}>(and reward)</span>{" "}
          for learning how to build real automations. You will learn how to take any inefficient or repetitive manual task and turn it into a task that takes care of itself.
        </p>
...
function HowItWorksSection({ dir }: { dir: number }) {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center overflow-hidden" style={{ background: "#F5F0E8" }}>
      <motion.div className="w-full flex flex-col" custom={dir} variants={contentVariants} initial="enter" animate="center" exit="exit">
...
/* ─── Integrations ───────────────────────────────────────── */
const integrationLogos: Array<{ slug: string; name: string; top: string; left: string; size: number; rot: number; src?: string }> = [
  { slug: "notion",       name: "Notion",        top: "6%",  left: "29%", size: 80, rot:  3 },
  { slug: "github",       name: "GitHub",        top: "8%",  left: "53%", size: 80, rot: -6 },
  { slug: "huggingface",  name: "Hugging Face",  top: "5%",  left: "77%", size: 80, rot:  5 },
  { slug: "discord",      name: "Discord",       top: "20%", left: "16%", size: 80, rot: -3 },
  { slug: "airtable",     name: "Airtable",      top: "19%", left: "42%", size: 80, rot:  7 },
  { slug: "cloudflare",   name: "Cloudflare",    top: "21%", left: "66%", size: 80, rot: -5 },
  { slug: "stripe",       name: "Stripe",        top: "18%", left: "89%", size: 80, rot:  4 },
  { slug: "google",       name: "Gemini",        top: "33%", left: "6%",  size: 80, rot:  4 },
  { slug: "whatsapp",     name: "WhatsApp",      top: "32%", left: "29%", size: 80, rot: -7 },
  { slug: "meta",         name: "Meta",          top: "34%", left: "53%", size: 80, rot:  6 },
  { slug: "anthropic",    name: "Claude",        top: "31%", left: "77%", size: 80, rot: -3 },
  { slug: "gmail",        name: "Gmail",         top: "46%", left: "16%", size: 80, rot:  5 },
  { slug: "mailchimp",    name: "Mailchimp",     top: "47%", left: "42%", size: 80, rot: -6 },
  { slug: "supabase",     name: "Supabase",      top: "45%", left: "66%", size: 80, rot:  4 },
  { slug: "clickup",      name: "ClickUp",       top: "48%", left: "89%", size: 80, rot: -5 },
  { slug: "facebook",     name: "Facebook",      top: "59%", left: "6%",  size: 80, rot:  7 },
  { slug: "googledrive",  name: "Google Drive",  top: "58%", left: "29%", size: 80, rot: -4 },
  { slug: "vonage",       name: "Vonage",        top: "60%", left: "53%", size: 80, rot:  5 },
  { slug: "instagram",    name: "Instagram",     top: "57%", left: "77%", size: 80, rot: -5 },
  { slug: "googlesheets", name: "Google Sheets", top: "72%", left: "16%", size: 80, rot:  3 },
  { slug: "slack",        name: "Slack",         top: "71%", left: "29%", size: 80, rot: -4, src: "https://cdn.hackclub.com/019cee17-6c23-776d-9d1b-48582fc3ca3e/SLA-Slack-From-Salesforce-Logo-WHITE.png" },
  { slug: "calendly",     name: "Calendly",      top: "71%", left: "42%", size: 80, rot: -7 },
  { slug: "googleads",    name: "Google Ads",    top: "73%", left: "66%", size: 80, rot:  6 },
...
function IntegrationsSection({ dir, logoY }: { dir: number; logoY: number }) {
  ...
  return (
    <div className="w-full h-full relative overflow-hidden" style={{ background: "#0F1923" }}>
      <div style={{ position: "absolute", inset: "3% 0", willChange: "transform", transform: `translateY(${logoY}px) translateZ(0)`, transition: "transform 0.45s cubic-bezier(0.22, 1, 0.36, 1)" }}>
        {integrationLogos.map((item, i) => (
          <div
            ...
            style={{
              ...
              opacity: visible ? 1 : 0,
              transform: visible ? `translateY(0px) rotate(${item.rot}deg)` : `translateY(-28px) rotate(${item.rot}deg)`,
              transition: `opacity 0.5s ease ${i * 40}ms, transform 0.5s ease ${i * 40}ms`,
            }}
          >
            <div style={{ width: item.size, height: item.size, background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.14)", borderRadius: "14px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <img
                src={item.src ?? `https://cdn.simpleicons.org/${item.slug}`}
                alt={item.name}
                draggable={false}
                style={{ width: item.size * 0.48, height: item.size * 0.48, filter: item.src ? "none" : "brightness(0) invert(1)", userSelect: "none", objectFit: "contain" }}
              />
            </div>
          </div>
        ))}
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-6 pointer-events-none">
        <motion.div custom={dir} variants={contentVariants} initial="enter" animate="center" exit="exit">
          <div style={{ background: "rgba(15,25,35,0.6)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.18)", boxShadow: "0 8px 32px rgba(0,0,0,0.18), inset 0 1px 0 rgba(255,255,255,0.12)", borderRadius: "20px", padding: "2.5rem 3rem", maxWidth: "640px", margin: "0 auto" }}>
            <h2 className="font-sans text-4xl sm:text-5xl font-extrabold mb-4 leading-tight" style={{ color: "#00E5A0" }}>
              We'll fund the tools you need
            </h2>
            <p className="font-sans text-base sm:text-lg leading-relaxed" style={{ color: "rgba(245,240,232,0.8)" }}>
...
function RsvpSection({ dir }: { dir: number }) {
  return (
    <div className="w-full h-full flex items-center justify-center overflow-hidden relative" style={{ background: "#F5F0E8" }}>
      <div style={{ position: "absolute", bottom: "-4%", right: "-1%", fontSize: "22vw", fontWeight: 900, color: "rgba(15,25,35,0.04)", lineHeight: 1, userSelect: "none", pointerEvents: "none", fontFamily: "sans-serif", letterSpacing: "-0.04em" }}>
        JOIN
      </div>
      <motion.div className="w-full max-w-5xl mx-auto px-8 sm:px-12 text-center" custom={dir} variants={contentVariants} initial="enter" animate="center" exit="exit">
        <div className="mb-6">
          <span className="font-sans text-xs font-bold uppercase tracking-[0.25em]" style={{ color: "#FF5733" }}>
            Join Automake
          </span>
        </div>
        <h2 className="font-sans font-extrabold mb-6 leading-tight" style={{ color: "#0F1923", fontSize: "clamp(2.8rem, 6vw, 5rem)" }}>
          Ready to{" "}
          <span style={{ display: "inline", background: "#00E5A0", borderRadius: "6px", padding: "0 10px 2px" }}>
            ship?
          </span>
        </h2>
        <p className="font-sans leading-relaxed mb-10 mx-auto" style={{ color: "#0F1923", fontSize: "clamp(1rem, 2vw, 1.3rem)", maxWidth: "600px" }}>
          Build a real automation, submit it, earn credits, and unlock rewards. Guides are free and open to everyone, you don't need to sign up to start.
        </p>
        <a href={RSVP_URL} target="_blank" rel="noopener noreferrer">
          <motion.span
            whileHover={{ rotate: -1, y: 2 }}
    ...
    >
      ...
      >
        <div className="text-center mb-8">
          <h2 className="font-sans text-4xl sm:text-5xl font-extrabold mb-3" style={{ color: "#0F1923" }}>
            <mark>FAQ</mark>
          </h2>
...
function FooterSection({
  ...
  return (
    ...
    >
      <motion.div
        className="w-full max-w-6xl mx-auto px-8 md:px-12 py-12 mt-12 ml-12"
        custom={dir} variants={contentVariants} initial="enter" animate="center" exit="exit"
      >
        <p className="mb-4 font-sans text-lg md:text-xl font-bold" style={{ color: "#F5F0E8" }}>
          A project by{" "}
          <a href="https://hackclub.com?utm_source=automake" target="_blank" rel="noopener noreferrer" className="underline transition-colors" style={{ color: "#00E5A0" }}>
            Hack Club
          </a>{" "}
          built by @Oba.
        </p>
        <p className="font-sans text-sm md:text-base mb-10 max-w-3xl leading-relaxed" style={{ color: "rgba(245,240,232,0.7)" }}>
          Hack Club is a 501(c)(3) nonprofit and network of 60k+ technical high schoolers. We believe you learn best by building so we're creating community and providing grants so you can make awesome projects. In the past few years, we've{" "}
          <a href="https://summer.hackclub.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#00E5A0] transition-colors" style={{ color: "rgba(245,240,232,0.7)" }}>
            partnered with GitHub to run Summer of Making
          </a>
          ,{" "}
          <a href="https://github.com/hackclub/the-hacker-zephyr" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#00E5A0] transition-colors" style={{ color: "rgba(245,240,232,0.7)" }}>
            hosted the world's longest hackathon on land
          </a>
          , and{" "}
          <a href="https://www.youtube.com/watch?v=QvCoISXfcE8" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#00E5A0] transition-colors" style={{ color: "rgba(245,240,232,0.7)" }}>
        ...
        <div className="flex flex-wrap gap-x-16 gap-y-8">
          <div className="flex flex-col">
            <p className="mb-3 font-sans text-base md:text-lg font-extrabold" style={{ color: "#F5F0E8" }}>Hack Club</p>
            <div className="font-sans text-sm md:text-base space-y-2" style={{ color: "rgba(245,240,232,0.7)" }}>
              {[
                ...
                <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" className="block hover:text-[#00E5A0] transition-colors">{l.label}</a>
              ))}
            </div>
          </div>
          <div className="flex flex-col">
            <p className="mb-3 font-sans text-base md:text-lg font-extrabold" style={{ color: "#F5F0E8" }}>Automake</p>
            <div className="font-sans text-sm md:text-base space-y-2" style={{ color: "rgba(245,240,232,0.7)" }}>
              {[
                ...
                <Link key={l.label} href={l.href}>
                  <span className="block hover:text-[#00E5A0] transition-colors cursor-pointer">{l.label}</span>
                </Link>
              ))}
            </div>
          </div>
          <div className="flex flex-col">
            <p className="mb-3 font-sans text-base md:text-lg font-extrabold" style={{ color: "#F5F0E8" }}>Resources</p>
            <div className="font-sans text-sm md:text-base space-y-2" style={{ color: "rgba(245,240,232,0.7)" }}>
              {[
...
export default function Landing() {
  ...
  useEffect(() => {
    const onWheel = (e: WheelEvent) => {
      ...
      if (current === INTEG_SECTION && !transitioning.current) {
        ...
        setIntegLogoY((prev) => Math.max(-70, Math.min(70, prev + scrollDir * -35)));
  ...
  const containerVariants = {
    ...
    center: { y: 0, scale: 1, transition: { duration: 0.88, ease: [0.22, 1, 0.36, 1] } },
    exit: (d: number) => ({
      y: d > 0 ? "-18%" : "18%",
      scale: 0.9, opacity: 0,
      ...
      <div style={{ height: "calc(100vh - 64px)", overflow: "hidden", position: "relative" }}>
        <AnimatePresence mode="popLayout" custom={dir}>
          ...
          >
            ...
            {current === 5 && <FaqSectionContent dir={dir} onScrollStateChange={setScrollState} />}
            {current === 6 && <FooterSection dir={dir} onScrollStateChange={setScrollState} />}
          </motion.div>
        </AnimatePresence>
