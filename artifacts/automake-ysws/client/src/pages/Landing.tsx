    ...
    >
      ...
      >
        ...
        <p
          ...
          style={{ color: "#0F1923", fontSize: "clamp(1.1rem, 2.2vw, 1.5rem)", maxWidth: "780px" }}
        >
          Automations can be used for amazing things. They power useful tools like Slack bots or fun email responders.{" "}
          <span style={{ fontWeight: 800, color: "#00E5A0" }}>Automake</span> exists to provide a place{" "}
          <span style={{ fontWeight: 800, color: "#00E5A0" }}>(and reward)</span> for learning how to build real automations. You will learn how to take any inefficient or repetitive manual task and turn it into a task that takes care of itself.
        </p>
              ...
              >
                <div
                  style={{
                    ...
                    color: "rgba(15,25,35,0.07)", lineHeight: 1,
                ...
                <div className="relative z-10">
                  <p className="font-sans font-bold text-base" style={{ color: "#0F1923" }}>
                    {step.label}
                  </p>
                </div>
              </motion.div>
          ...
          >
            ...
            >
              <img
                ...
                draggable={false}
                style={{
                  width: item.size * 0.48, height: item.size * 0.48,
    ...
    >
      ...
      >
        ...
        <p className="font-sans text-sm md:text-base mb-10 max-w-3xl leading-relaxed" style={{ color: "rgba(245,240,232,0.7)" }}>
          ...
          building so we're creating community and providing grants so you can make awesome projects. In the past few
          years, we've{" "}
          ...
          <div className="flex flex-col">
            ...
            <div className="font-sans text-sm md:text-base space-y-2" style={{ color: "rgba(245,240,232,0.7)" }}>
              {[
                ...
                <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" className="block hover:text-[#00E5A0] transition-colors">
                  {l.label}
                </a>
              ))}
            </div>
