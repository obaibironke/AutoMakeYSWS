...
export default function Dashboard() {
  ...
  const isAuthed = !!sessionStorage.getItem("slack_id");
  if (!isAuthed) {
  ...
  const handleProjectCreated = (recordId: string) => {
    setShowCreateModal(false);
    setLocation(`/projects/${recordId}`);
  };
        ...
        >
          ...
          {projectsLoading ? (
            ...
            >
              ...
              >
                Build an automation, create it, and earn credits. Follow a guide
                to get started.
              </p>
