...
function DashboardNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 shadow-sm" style={{ background: "#0F1923", borderBottom: "1px solid rgba(0,229,160,0.15)" }}>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <span
              ...
              style={{ color: "#00E5A0", borderBottom: "2px solid #00E5A0", paddingBottom: "2px" }}
            >
              Dashboard
            </span>

            {/* Shop — big button like RSVP */}
            <Link href="/shop">
              <span
                className="font-sans text-sm font-bold px-5 py-2 rounded-lg cursor-pointer transition-all inline-block"
                style={{ background: "#FF5733", color: "white", boxShadow: "2px 2px 0px #F5F0E8" }}
              >
                Shop
              </span>
            </Link>
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setVerified(sessionStorage.getItem("verified") === "true");
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        ...
        >
          {[
            ...
            { label: "Verification", value: verified ? "Verified ✓" : "Unverified", accent: verified ? "#00E5A0" : "#FF5733" },
          ].map((stat, i) => (
            <div
              key={i}
        ...
        >
          ...
          >
            ...
            <h3 className="font-sans text-xl font-extrabold mb-2" style={{ color: "#0F1923" }}>
              No projects yet
            </h3>
