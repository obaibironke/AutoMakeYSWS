...
export const guides: Guide[] = [
  {
    ...
    steps: [
      ...
      "Configure your authtoken by running the following command in PowerShell:",
      ...
      "Start n8n locally by running the following command in PowerShell:",
      "`docker run -d --restart unless-stopped -p 5678:5678 -v n8n_data:/home/node/.n8n -e N8N_EDITOR_BASE_URL=https://YOUR-NGROK-DOMAIN -e WEBHOOK_URL=https://YOUR-NGROK-DOMAIN n8nio/n8n`",
